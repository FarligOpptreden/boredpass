...
$(document).ready(function() {
  ...
  Listings.create = function() {
    ...
    var progress = function(form, factor) {
      ...
      var stepIndicator = $(".wizard-steps > nav > a").eq(
      ...
      var listing = {
        ...
        owner:
          content
            ...
            .toLowerCase() === "yes",
        telephone:
          content.find("#telephone-code").val() +
          content.find("#telephone").val(),
        cellphone:
          content.find("#cellphone-code").val() +
          content.find("#cellphone").val(),
      ...
      $.ajax({
        ...
        success: function(d, s, x) {
          ...
          c.find(".banners a").each(function() {
            ...
            image === $("section.banner").data("banner") &&
    ...
    content.find("#businessname").blur(function(e) {
      ...
      $.ajax({
        ...
        success: function(d, s, x) {
          ...
          if (!d || !d.success || !d.listings || !d.listings.length) return;

          var dupes = $(
            '<div class="duplicates"><p>We found some possible duplicate listings. Want to confirm before you add this one?</p></div>'
          );
