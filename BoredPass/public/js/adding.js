...
$(document).ready(function() {
  ...
  (function() {
    ...
    var progress = function(form, factor) {
      ...
      var stepIndicator = $(".wizard-steps > div > a").eq(
        wizardForms.index(form)
      );
      ...
      $(".wizard-instructions-content").html(
        newForm
          .find(".instructions-template")
          .children()
          .clone()
      );
    ...
    $("button.next, button.prev").click(function() {
      ...
      if ($(".wizard-content")) prefix = ".active ";
  ...
  (function() {
    ...
    $(".trading-hours input").change(function() {
      ...
      if (isChecked) wrapper.find("select").removeAttr("disabled");
      else wrapper.find("select").attr("disabled", "disabled");
    });
    ...
    $("#post-activity").click(function() {
      ...
      var activity = {
        ...
        prices: {
          ...
          child:
            $("#price_kids").val() === "true"
              ? $("#price_kids_value").val()
              : null,
          adult:
            $("#price_adults").val() === "true"
              ? $("#price_adults_value").val()
              : null,
          pensioner:
            $("#price_pensioners").val() === "true"
              ? $("#price_pensioners_value").val()
              : null
        },
        tradingHours: {
          monday:
