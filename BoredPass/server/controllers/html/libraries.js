...
export default new Controller('/libraries')
    .handle({ route: '/tags/search', method: 'get', produces: 'json' }, (req, res) => TagsService.findMany({
    ...
    .handle({ route: '/tags/list', method: 'get', produces: 'html' }, (req, res) => TagsService.findMany({
        filter: {},
        sort: { name: 1 }
    })
        .then(tags => res.render('partials/tag_library', {
