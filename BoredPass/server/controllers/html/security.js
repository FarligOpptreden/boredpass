...
export default new Controller('/secure')
    ...
    .handle({ route: '/sign-out', method: 'get', produces: 'json' }, (req, res) => SecurityService.signOut(req, res)
        .then(r => res.send(r))
        .catch(r => res.send(r))
    )
    .handle({ route: '/sign-in', method: 'post', consumes: 'json', produces: 'json' }, (req, res) => SecurityService.signIn(req.body, res)
        .then(r => res.send(r))
