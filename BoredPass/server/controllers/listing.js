...
export default new Controller("/listings")
  .handle({ route: "/duplicates/:search", method: "get", produces: "json" }, get_json_duplicates_search)
  .handle({ route: "/add", method: "get", produces: "html" }, get_html_add)
  .handle({ route: "/add/wizard", method: "get", produces: "html" }, get_html_add_wizard)
  .handle({ route: "/add", method: "post", produces: "html" }, post_html_add)
  .handle({ route: "/:id/added", method: "get", produces: "html" }, get_html_id_added)
  ...
  .handle({ route: "/:id/review", method: "get", produces: "html" }, get_html_id_review)
  .handle({ route: "/:id/:name", method: "get", produces: "html" }, get_html_id);
