...
import { LocationService, SearchService, ListingsService } from "../services";
...
export default new Controller("/search")
  ...
  .handle({ route: "/location", method: "get", produces: "html" }, (req, res) =>
  ...
  .handle({ route: "/:page", method: "get", produces: "html" }, (req, res) =>
    SearchService.find({
      tags: (req.query.tags && req.query.tags.split(",")) || [],
      distance:
        (req.query.distance !== "any" && parseFloat(req.query.distance)) ||
        null,
      location:
        (req.query.lat &&
          req.query.lon && {
